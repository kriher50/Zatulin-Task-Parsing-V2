<div class="flex justify-center mt-4">
    ...
    <button wire:click="FetchNewsButton" wire:loading.attr="disabled" class="flex items-center space-x-2 bg-gray-300 dark:bg-gray-600 p-3 rounded-lg transition-all duration-300 ease-in-out hover:bg-gray-400 dark:hover:bg-gray-500 hover:shadow-lg hover:shadow-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400">
